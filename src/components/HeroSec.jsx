...
const HeroSec = () => {
    return (
        <div id='home' className=' relative mx-auto container'>
            ...
            <div class=" absolute inset-0 translate-x-[10px] -left-20 top-12 z-10  bg-gradient-to-b w-[33%]  rounded-full h-[450px] blur-3xl from-purple-600/60 opacity-30 via-purple-500/60 to-purple-400/60 "></div>
                <div className="flex flex-col text-white justify-center items-center lg lg:py-12 lg:px-10 p-4  rounded-sm  lg:text-left">
                    ...
                    <div className=" w-full flex sm:items-center justify-center lg:px-10 sm:flex-row sm:space-y-0 space-x-4 lg:justify-start ">
                        <a href="#contact" className="px-6 py-2 bg-[#6318F1] hover:bg-gradient-to-r hover:from-[#FC466B]/40 hover:to-[#3F5EFB]/40 hover:scale-110 duration-200 text-white font-bold rounded-full transition-transform transform-gpu  hover:shadow-lg">
                            Join Now
                        </a>
                        <a href="#services" className="px-6 py-2 bg-[#35314D] hover:bg-gradient-to-r hover:from-[#FC466B]/40 hover:to-[#3F5EFB]/40 hover:scale-110 duration-200 text-white font-bold rounded-full transition-transform transform-gpu  hover:shadow-lg">
                            Explore &#160;
                        </a>
                    </div>
                </div>
